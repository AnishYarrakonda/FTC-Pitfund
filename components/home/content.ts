...
export const COMPANY_CARDS = [
  { title: 'Write up to ten questions of your own.', label: 'Your questions', art: 'a', href: '#bento-questions' },
  { title: 'Only approved teams can pitch you.', label: 'Verified teams', art: 'b', href: '#bento-verified' },
  { title: 'Every pitch is reviewed before it reaches you.', label: 'Human review', art: 'c', href: '#bento-review' },
  { title: 'Answer Interested or Not a fit in one click.', label: 'Clear answers', art: 'd', href: '#bento-match' },
  { title: 'Contacts are shared only on a match.', label: 'Private by default', art: 'e', href: '#faq' },
  { title: 'Invite your colleagues as editors.', label: 'Shared account', art: 'f', href: COMPANY_HREF },
  { title: 'Nothing to pay, and no money handled.', label: 'Always free', art: 'g', href: '#faq' },
  { title: 'Every team page is one link away.', label: 'Team pages', art: 'h', href: '#bento-public' },
] as const

export const NEWS = [
  {
    title: 'The 2026–27 pitch season is open.',
    body: 'Seasons run September 1 to August 31. Each team can pitch each company once per season, and withdrawing before a reply frees the slot.',
    cta: 'Start pitching',
    href: TEAM_HREF,
    art: 'season',
    caption: 'Season 2026–27',
  },
  {
    title: 'Companies now write their own questions.',
    body: 'Up to ten questions, or three good defaults. Teams answer exactly what each company asks, and a reviewer checks the answers first.',
  ...
  },
  {
    ...
    body: 'Use Google or a six-digit code sent to your email. There are no passwords to remember and none to leak.',
    cta: 'Sign in',
    href: '/login',
    art: 'signin',
  ...
  {
    title: 'Every approved team gets a public page.',
    body: 'Name, number, logo, summary and deck on one link you can send anywhere, on or off FTC Pitfund.',
    cta: 'Build your page',
    href: TEAM_HREF,
    art: 'page',
    caption: 'Team pages',
  ...
  {
    title: 'Built by an FTC team, for FTC teams.',
    body: 'FTC Pitfund is an independent project from FTC Team 31579 Exodius. It is not affiliated with or endorsed by FIRST®.',
    cta: 'Read the FAQ',
    href: '#faq',
    art: 'team',
    caption: 'Team 31579',
