...
export const SPONSORS: SponsorFixture[] = [
  {
    ...
    questions: [
      ...
      q('bl-mentors', 'Would your team want an engineer from Ribosome as a mentor?', false),
    ],
    status: 'approved',
    members: ['sponsor', { email: 'member-ribosome@pitfund.test', name: 'Kevin Moore', jobTitle: 'Staff Engineer' }],
  },
  {
    name: 'Nucleotide Credit Union',
  ...
  {
    name: 'Mitochondria Machine Works',
    ...
    status: 'approved',
    members: [{ email: 'member-mitochondria@pitfund.test', name: 'Rosa Delgado', jobTitle: 'Operations Manager' }],
  },
  {
    name: 'NeuroPeak Software',
    ...
    questions: [],
    status: 'approved',
    members: [{ email: 'member-neuropeak@pitfund.test', name: 'Aaron Fields', jobTitle: 'Developer Relations' }],
  },
  {
    name: 'Plasmid Point Energy',
    ...
    status: 'approved',
    members: [{ email: 'member-plasmid@pitfund.test', name: 'Janelle Ward', jobTitle: 'Community Relations' }],
  },
  {
    name: 'Telomere Aerospace',
    ...
    questions: [],
    status: 'approved',
    members: [{ email: 'member-telomere@pitfund.test', name: 'Victor Hsu', jobTitle: 'Program Manager' }],
  },
  {
    name: 'Synapse Fabrication',
    ...
    status: 'approved',
    members: [{ email: 'member-synapse@pitfund.test', name: 'Megan Lowe', jobTitle: 'Owner' }],
  },
  {
    name: 'Lysosome Medical Devices',
    ...
    status: 'approved',
    members: [{ email: 'member-lysosome@pitfund.test', name: 'Irene Walsh', jobTitle: 'Giving Program Lead' }],
  },
  {
    name: 'BioBuzz Foundation',
    ...
    status: 'approved',
    members: [{ email: 'member-biobuzz@pitfund.test', name: 'Eleanor Brandt', jobTitle: 'Program Officer' }],
  },
  {
    name: 'Allele Components',
  ...
  },
  {
    ...
    questions: [],
    status: 'pending',
    members: [{ email: 'member-genome@pitfund.test', name: 'Paul Ostrowski', jobTitle: 'Partner' }],
  },
  {
    name: 'QuickClone Promotions',
    ...
    members: [{ email: 'member-quickclone@pitfund.test', name: 'Rick Dawson', jobTitle: 'CEO' }],
  },
  {
    name: 'Vacuole Promotions',
    ...
    status: 'suspended',
    members: [{ email: 'member-vacuole@pitfund.test', name: 'Tara Quinn', jobTitle: 'Account Director' }],
  },
]

export const PITCHES: Array<[number, string, PitchStatus]> = [
  [31579, 'Ribosome Robotics', 'matched'],
  [31579, 'Nucleotide Credit Union', 'sent'],
  [31579, 'Mitochondria Machine Works', 'in_review'],
  [31579, 'NeuroPeak Software', 'changes_requested'],
  [31579, 'Plasmid Point Energy', 'rejected'],
  [31579, 'Telomere Aerospace', 'declined'],
  [31579, 'Synapse Fabrication', 'draft'],
  [31579, 'Lysosome Medical Devices', 'withdrawn'],
  [24890, 'Ribosome Robotics', 'sent'],
  [24890, 'Nucleotide Credit Union', 'in_review'],
  [24890, 'NeuroPeak Software', 'draft'],
  [24890, 'Synapse Fabrication', 'matched'],
  [16072, 'Ribosome Robotics', 'declined'],
  [16072, 'Nucleotide Credit Union', 'matched'],
  [16072, 'Mitochondria Machine Works', 'sent'],
  [20443, 'Ribosome Robotics', 'in_review'],
  [20443, 'Plasmid Point Energy', 'sent'],
  [20443, 'Telomere Aerospace', 'changes_requested'],
  [18215, 'Ribosome Robotics', 'sent'],
  [18215, 'Lysosome Medical Devices', 'in_review'],
  [18215, 'Synapse Fabrication', 'rejected'],
  [22761, 'Nucleotide Credit Union', 'declined'],
  [22761, 'NeuroPeak Software', 'matched'],
  [22761, 'Mitochondria Machine Works', 'withdrawn'],
  [14398, 'Ribosome Robotics', 'draft'],
  [14398, 'Plasmid Point Energy', 'in_review'],
  [25530, 'Nucleotide Credit Union', 'sent'],
  [25530, 'Telomere Aerospace', 'sent'],
  [19904, 'Ribosome Robotics', 'changes_requested'],
  [27112, 'Lysosome Medical Devices', 'matched'],
  // Waiting for review but blocked: the company was suspended after the team pitched it.
  [19904, 'Vacuole Promotions', 'in_review'],
  // Sent to Ribosome (the sponsor persona), then withdrawn: the inbox shows a read-only notice.
  [22761, 'Ribosome Robotics', 'withdrawn'],
]
...
/**
 * Exodius's Synapse Fabrication draft was started before Summit edited its questions: one saved
 * answer belongs to a question Summit removed, one to a prompt Summit reworded, and the new
 * required question is unanswered. The composer shows "Synapse Fabrication updated its questions".
 */
