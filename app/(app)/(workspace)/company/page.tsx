    ...
    <PageContainer>
      ...
      <CompanyEditor
        ...
        members={
          <MembersSection
            viewerId={viewer.id}
            viewerRole={viewer.sponsor.role}
            description={`Everyone here shares ${profile.name}’s account and gets the email when a pitch arrives. The owner decides who is on it.`}
            members={members}
            ...
            actions={{
              leave: leaveCompanyAction,
              remove: removeCompanyMemberAction,
              transfer: transferCompanyOwnershipAction,
              invite: inviteCompanyMember,
              resend: resendCompanyInvite,
              revoke: revokeCompanyInvite,
            }}
            ...
            copy={{
              ...
              onlyMember: `You own ${profile.name} and you’re its only member. To leave, invite a coworker and make them the owner, or email ${SUPPORT_EMAIL} to close the company.`,
              ownerCantLeave: `You own ${profile.name}. Make a coworker the owner before you leave.`,
              orgLabel: profile.name,
